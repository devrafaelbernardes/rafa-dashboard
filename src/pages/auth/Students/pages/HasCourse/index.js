...
import objectQuery, { GET_STUDENTS_HAVE_COURSE, getImageUser } from 'services/api/query';
...
export function HasCourse() {
    ...
    const { data, loading, fetchMore } = useQuery(GET_STUDENTS_HAVE_COURSE, objectQuery(
        objectPagination({
    ...
    const TEXTS = Texts.PAGE_AUTH_STUDENTS.HAS_COURSE;
