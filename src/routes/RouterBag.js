...
// PAGES AUTH
import Home from 'pages/auth/Bag/pages/Home';
import Add from 'pages/auth/Bag/pages/Add';
import Update from 'pages/auth/Bag/pages/Update';
import UpdatePosition from 'pages/auth/Bag/pages/UpdatePosition';

export function RouterBag() {
    const ROUTER = BagURL().ROUTER;
